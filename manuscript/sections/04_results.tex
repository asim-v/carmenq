...
The full frontier is stated first, followed by its consequences. Readers interested mainly in the experimental message can focus on the highlighted balanced case and the resource comparison; all proof details are in \cref{app:proofs}.
...
A weak measurement of the two parity subspaces attains \eqref{eq:collective}. The device still retains only a classical outcome; its advantage comes from seeing all carriers together. The comparator therefore isolates the advantage lost when the apparatus must operate as a stream.
